...
En este repositorio se encuentra la solución a la prueba técnica en el programa Calculadora.java.
...
En cuanto al programa, el lenguaje empleado es java y está dividido en una serie de métodos con tareas específicas. Estos métodos son:
...
### Parte más compleja
La programación de los errores obtenidos al escribir un parámetro fuera del rango especificado, aunque no supuso un problema significativo ya que después de una breve reflexión fue resuelto.
